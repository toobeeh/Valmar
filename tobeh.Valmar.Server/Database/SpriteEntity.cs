...
namespace tobeh.Valmar.Server.Database
{
    public partial class SpriteEntity
    {
        ...
        [Column(TypeName = "int(11)")] public int Cost { get; set; }
        public bool Special { get; set; }

        [Column("EventDropID", TypeName = "int(11)")]
        public int EventDropId { get; set; }

        [Column(TypeName = "text")] public string? Artist { get; set; }
        [Column(TypeName = "int(11)")] public int Rainbow { get; set; }
        [Column(TypeName = "int(11)")] public int? RequiredFlags { get; set; }
    }
}